function simulate(data, svg) {
    ...
    const colorScale = d3.scaleOrdinal(d3.schemeSet2) // Changed from d3.schemeCategory10 to d3.schemeSet2
     .domain(topCountries);
    ...
    const getColorByCountry = (countries) => {
        ...
        return "#B0C4DE"; // Changed from #A9A9A9 to #B0C4DE (Light Steel Blue)
    };
    ...
    const link_elements = main_group.append("g")
        ...
        .enter()
        .append("line")
        .attr("stroke", "#D3D3D3"); // Changed from "grey" to "#D3D3D3"
